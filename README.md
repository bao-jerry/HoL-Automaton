...
## Open Questions:
- A first-principles proof for the 30.0% stabilizing limit that does not smuggle in post-hoc assumptions. In particular, overfitting a model to the experimental observations without justifying the modelling assumptions from first principles is invalid.
